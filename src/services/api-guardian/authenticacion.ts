...
import { ResIAuthenticacion, ResIVerificarAuthenticacion, loginDto } from "../../interfaces/ILogin";
...
export async function refreshToken() {
    return await axios.get<IResponse<ResIAuthenticacion>>(`${process.env.REACT_APP_API_GUARDIAN}api/authenticate/refresh-token`);
}
